...
const float TRAIL_THRESHOLD = 0.05;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // Draw trail
    float trailActive = smoothstep(TRAIL_THRESHOLD, TRAIL_THRESHOLD * 2.0, lineLength);
    newColor = mix(newColor, trail, antialising(sdfTrail) * trailActive);
    // Draw current cursor
